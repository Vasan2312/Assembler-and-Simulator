...
def MoveImmediate_Float(given_list: list):
    ...
    if not error_flag:
        ...
        for line in instructions:
            ...
            if line[0] == 'add':
                ...
                print(Addition_Float(line[1:]))

            elif line[0] == 'sub':
                print(Subtraction(line[1:]))

            elif line[0] == 'subf':
                print(Subtraction_Float(line[1:]))

            elif line[0] == 'mov' and '$' in line[2]:
                print(MoveImmediate(line[1:]))

            elif line[0] == 'movf':
                if not MoveImmediate_Float(line[1:]):
                    error_flag = True
                    return False
                print(MoveImmediate_Float(line[1:]))
...
def has_imm_error(instr: str, arg: str):
