    ...
    if not error_flag:
        ...
        for line in instructions:
            ...
            if line[0] == 'add':
                ...
                print(UnconditionalJump(line[1:], converter(str(labels[line[1]]))))
    
            elif line[0] == 'jlt':
                print(JumpIfLessThan(line[1:], converter(str(labels[line[1]]))))
    
            elif line[0] == 'jgt':
                print(JumpIfgreaterThan(line[1:], converter(str(labels[line[1]]))))
